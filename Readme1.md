...
<img width="341" height="266" alt="image" src="https://github.com/user-attachments/assets/ab4cf8c9-c2c5-40c1-b69e-2c7a0c4a30b2" />
...
OID – urile absolute 
	Specifică o cale către un atribut începând de la rădăcina arborelui OID;
...
1.	Enterprise ( OID ce descrie aplicația, indică baza ierarhică a Trap-ului ,permite definirea de alerte specifice – 1.3.6.1.4.1.2.6.258- ramură enterprise privată – pentru definirea alertelor definite de utilizator) 
2.	Agent-addr ( conține adresa IP a agentului care a generat trap-ul – ajută la identificarea dispozitivului de pe care provine evenimentul – format IPv4 – 4 octeți )
3.	Generic-trap (cod numeric între 0 și 6 care descrie tipul general al evenimentului – pentru evenimente definite de utilizator, se folosește întotdeauna valoarea 6 ) : generic-trap = 6 (enterpriseSpecific)
Sub această categorie sunt incluse Trap-urile definite în ramura: 
1.3.6.1.4.1.2.6.258.0.x
4.	Specific-trap ( devine relevant doar atunci când generic-trap =6)   - este un număr de tip întreg ce diferențiază evenimentele proprii definite , de exemplu :
...
a)	Intrare în MIB pentru valoarea temperaturii 
...
- are următorul format :1.3.6.1.4.1.9999.1.3.0 – systemTemperature ;
      b) Intrare în MIB pentru unitatea de măsură 
...
OID numeric	Obiect	Tip ASN1	Acces	Descriere
...
1.3.6.1.4.1.9999.1.3.1	temperatureUnit	Integer	read-write	Unitatea de masură (1= ° C, 2= ° F, 3= ° K)
